# import sqlalchemy
# from flask import render_template, url_for, request, redirect, flash, make_response, jsonify
# from flask_login import login_required, current_user, login_user, logout_user
# from werkzeug.security import generate_password_hash, check_password_hash
#
# from app import app, db
# from app import get_accessible_folders, update_last_change_date
# from app import Note, AppData, Folder, User
#
#
# @app.route('/')
# def home():
